...
const PixelMapCanvas = ({
  ...
  return (
    <div className="pixelMapCanvas">
      <div className="pixelMapCanvas__controls">
        <Button
      ...
      <div className="pixelMapCanvas__container">
        <canvas
          ref={canvasRef}
          width={1024}
          height={650}
        ...
        {pixelsType === "Grouped" &&
          ...
          selectedPixels.length > 0 && (
            <div className="pixelMapCanvas__alert">
              Виберіть прямокутну область або переключіть режим на Single
            </div>
          )}
      </div>
    </div>
